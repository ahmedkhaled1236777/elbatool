...
class Addindusterialcost extends StatefulWidget {
  final int stampid;

  Addindusterialcost({super.key, required this.stampid});

  @override
  State<Addindusterialcost> createState() => _AddindusterialcostState();
}

class _AddindusterialcostState extends State<Addindusterialcost> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: BlocBuilder<InduxterialcostCubit, InduxterialcostState>(
                                  ...
                                  return Column(
                                    children: [
                                      ...
                                      BlocConsumer<IndusterialcostCubit,
                                        ...
                                        builder: (context, state) {
                                          if (state
                                              is addmyIndusterialcostloading)
                                            return loading();
