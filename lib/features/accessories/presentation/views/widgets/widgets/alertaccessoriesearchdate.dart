...
import 'package:agman/features/accessories/presentation/views/widgets/widgets/accessoriessearch.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class Alertaccessoriesearchdate extends StatelessWidget {
  @override
                            ...
                            custommaterialbutton(
                                ...
                                onPressed: () async {
                                  if ((BlocProvider.of<DateCubit>(context)
                                    ...
                                    navigateto(
                                        context: context,
                                        page: Accessoriessearch(
                                          startdate: BlocProvider.of<DateCubit>(
                                                  context)
                                              .date3,
