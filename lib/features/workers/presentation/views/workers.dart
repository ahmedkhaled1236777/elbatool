...
import 'package:agman/features/workers/presentation/views/widgets/alertsearch.dart';
import 'package:agman/features/workers/presentation/views/widgets/customworkertimeritem.dart';
import 'package:agman/features/workers/presentation/views/widgets/editworker.dart';
import 'package:agman/features/workers/presentation/views/widgets/workeritem.dart';
                              ...
                              child: Customworkeritem(
                                                    ...
                                                    salary: TextEditingController(
                                                        text:
                                                            BlocProvider.of<WorkersCubit>(context)
                                                                .workers[i]
                                                                .salary),
                                                    phone: TextEditingController(text: BlocProvider.of<WorkersCubit>(context).workers[i].phone),
                                                    id: BlocProvider.of<WorkersCubit>(context).workers[i].id!.toInt()),
                                              );
                                            });
                                      },
                                      icon: Icon(editeicon)),
                                  delete: IconButton(
                                      onPressed: () {
                                        awsomdialogerror(
                                            context: context,
                                            mywidget: BlocConsumer<WorkersCubit,
                                                WorkersState>(
                                              listener: (context, state) {
                                                if (state
