...
import 'package:agman/features/customers/presentation/view/widgets/customers/addcustomer.dart';
import 'package:agman/features/customers/presentation/view/widgets/customers/addinjectionmotion.dart';
import 'package:agman/features/customers/presentation/view/widgets/customers/editdialog.dart';
                ...
                child: RefreshIndicator(
                    ...
                    child: BlocBuilder<CustomersCubit, CustomersState>(
                      builder: (context, state) {
                        ...
                        return BlocProvider.of<CustomersCubit>(context)
                                .clients
                                .isEmpty
                            ? nodata()
                            : ListView.separated(
                                itemBuilder: (context, i) => InkWell(
                                      ...
                                      child: customtablcustomeritem(
                                          textStyle: Styles.gettabletextstyle(
                                              context: context),
                                          name: BlocProvider.of<CustomersCubit>(
                                                      context)
                                                  .clients[i]
                                                  .name ??
                                              "",
                                                          ...
                                                          child: ElevatedButton(
                                                              ...
                                                              onPressed:
                                                                ...
                                                                await BlocProvider.of<
                                                                        ...
                                                                        context)
                                                                    .deleteclient(
                                                                        clientid: BlocProvider.of<CustomersCubit>(context)
                                                                            .clients[i]
                                                                            .id!);
                                                              },
                                                              child: const Text(
